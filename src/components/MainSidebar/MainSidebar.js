...
const MainSidebar = ({ sidebar, handleToggleSidebar }) => {
    ...
    return (
        <nav className={sidebar === true ? "mainSidebar open  " : "mainSidebar menuVisiblity"}
        >
            <div className="d-flex" style={{ marginLeft: '32px', marginBottom: '30px'}}>
